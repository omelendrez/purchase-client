...
export const LOAD_USER_WORKFLOWS = 'LOAD_USER_WORKFLOWS'
export const SET_USER_WORKFLOWS = 'SET_USER_WORKFLOWS'

export const SAVE_DOCUMENT_STATUS = 'SAVE_DOCUMENT_STATUS'
export const LOAD_DOCUMENT_STATUS = 'LOAD_DOCUMENT_STATUS'
export const SET_DOCUMENT_STATUS = 'SET_DOCUMENT_STATUS'

export const IMPORT_REQUISITION = 'IMPORT_REQUISITION'
