<template>
  <b-container class="units" fluid>
    ...
    <b-table small hover outlined :items="units.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
