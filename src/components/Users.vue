<template>
  <b-container class="users" fluid>
    ...
    <b-table small hover striped outlined :items="users.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
