<template>
  <b-container class="workflows" fluid>
    ...
    <b-table small hover outlined :items="workflows.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
