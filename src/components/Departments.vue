<template>
  <b-container class="departments" fluid>
    ...
    <b-table small hover outlined :items="departments.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
