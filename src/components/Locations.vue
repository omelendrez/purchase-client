<template>
  <b-container class="locations" fluid>
    ...
    <b-table small hover striped outlined :items="locations.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
