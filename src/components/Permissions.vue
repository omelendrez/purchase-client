<template>
  <b-container class="permissions" fluid>
    ...
    <b-table small hover outlined :items="permissions.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
