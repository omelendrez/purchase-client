<template>
  <b-container class="projects" fluid>
    ...
    <b-table small hover outlined :items="projects.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
