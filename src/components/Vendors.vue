<template>
  <b-container class="vendors" fluid>
    ...
    <b-table small hover outlined :items="vendors.rows" :fields="fields" :filter="filter" :per-page="perPage" :current-page="currentPage" :show-empty="true" head-variant="light">
